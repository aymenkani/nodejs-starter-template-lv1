...
const chat = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    The context includes source links. If the answer is found in a file, strictly cite the source at the end of the answer using the provided Link format: [Source Name](Link).
