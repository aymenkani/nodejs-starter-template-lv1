...
Services encapsulate the application's business logic. They interact with data sources (like the database via [Prisma](#database-with-prisma)), external APIs, and other services to perform specific operations.
