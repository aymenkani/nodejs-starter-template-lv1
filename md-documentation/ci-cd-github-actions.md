...
4.  **Run Linting:** Executes ESLint to check for code style and potential errors. Refer to [Code Style and Formatting](./contributing.md#1-code-style-and-formatting).
5.  **Run Tests:** Executes Jest tests (unit and integration tests). Refer to [Testing](./testing.md).
6.  **Build Application:** Compiles the TypeScript code into JavaScript.
...
*   **Deployment Steps:** For actual deployment to a cloud provider (e.g., Render, AWS ECS, Kubernetes), you would add additional steps here using provider-specific GitHub Actions or CLI commands. Refer to [Cloud Deployment](./deployment.md#2-cloud-deployment) for more details.
